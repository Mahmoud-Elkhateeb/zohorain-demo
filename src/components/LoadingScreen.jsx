...
const LoadingScreen = () => {
    ...
    useEffect(() => {
        // This simulates the component being fully mounted
        ...
        <>
            ...
            <div className="bg-white min-h-screen flex items-center justify-center">
                <div className="text-center">
                    ...
                    <h1
                        className={`restaurant-name shimmer-text text-5xl font-light mb-4 ${isLoaded ? 'float-up' : 'opacity-0'}`}
                    ...
                    <div className={isLoaded ? 'float-up' : 'opacity-0'} style={{ animationDelay: '0.6s' }}>
                    ...
                    <div
                        className={`flex justify-center items-center space-x-1 ${isLoaded ? 'float-up' : 'opacity-0'}`}
