  ...
  return (
    <footer className="  bg-[#F9FAFB] px-4 py-4 flex flex-col md:flex-row justify-between items-center text-sm">
      ...
      <div className="flex items-center space-x-2 text-gray-600">
        <Link href="/restaurant-settings" passHref className="hover:text-blue-600  w-31 text-center font-[500] text-[#334567] transition-all duration-100">
          Restaurant settings
        </Link>
        <span className="text-[#BDC5D1] text-[1.1rem]">•</span>
        <Link href="/profile" passHref className="hover:text-blue-600 text-[#334567] font-[500]  w-15 text-center transition-all duration-100">
          Profile
        </Link>
        <span className="text-[#BDC5D1] text-[1.1rem]">•</span>
